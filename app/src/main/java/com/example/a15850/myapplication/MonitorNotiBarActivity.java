...
import com.example.a15850.myapplication.PushMessCache.MessageData;
...
public class MonitorNotiBarActivity extends Activity {
    ...
    private static MonitorNotiBarActivity activity = null;
    private static HttpReq req = new HttpReq();

    public static void actionStart(Context context){
        Intent intent = new Intent(context, MonitorNotiBarActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_monitor_noti_bar);
        ...
        ClearViews.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NotificationManager nm = (NotificationManager) MonitorNotiBarActivity.this.getSystemService(Context.NOTIFICATION_SERVICE);
        ...
        if (notification != null) {
            ...
            if (remoteV==null) {
                ...
                if(activity != null)
                    ...
                    AppLog.e("MonitorNotiBarActivity is null");
